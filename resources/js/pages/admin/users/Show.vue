            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-4">
                ...
                <Card class="lg:col-span-2">
                    ...
                    <CardContent class="space-y-6 pt-6">
                        ...
                        <div class="border-t border-border pt-6">
                            <h4
                                class="mb-4 flex items-center gap-2 font-semibold text-foreground"
                            >
                        ...
                        <div class="border-t border-border pt-6">
                            ...
                            <div class="flex flex-wrap gap-3">
                                <Badge
                                    :class="userTypeColors[user.user_type]"
                                    class="border font-medium"
                                >
                                    <component
                                        :is="userTypeIcons[user.user_type]"
                                        class="mr-1 h-3 w-3"
                                    />
                ...
                <div class="space-y-6 lg:col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <Card
                            class="border-emerald-200 bg-gradient-to-br from-emerald-500/10 to-emerald-600/5"
                        >
                            <CardContent class="p-4">
                                <div class="flex items-center justify-between">
                                    <div>
                        ...
                        <Card
                            class="border-orange-200 bg-gradient-to-br from-orange-500/10 to-orange-600/5"
                        >
                            <CardContent class="p-4">
                                <div class="flex items-center justify-between">
                                    <div>
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle class="text-foreground"
                                >Información del Sistema</CardTitle
                            >
                        </CardHeader>
                    ...
                    <CardContent>
                        <div v-if="activeLoans.length > 0" class="space-y-3">
                            <div
                                ...
                                :key="loan.id"
                                class="rounded-lg border border-border p-3 transition-colors hover:bg-accent/50"
                            >
                                <div
                                    class="mb-2 flex items-start justify-between"
                                >
                                    <p
                                        class="min-w-0 flex-1 pr-2 text-sm font-medium text-foreground"
                                    >
                                        {{
