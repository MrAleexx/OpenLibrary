                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="mt-1 text-muted-foreground">
                            Completa la información para agregar un nuevo libro
                            al catálogo
                        </p>
                    </div>
                    <Button
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p class="mt-1 text-xs">
                                            La información del archivo aparecerá
                                            aquí
                                        </p>
                                    </div>
                                </div>
                ...
                >
                    <CardHeader class="pb-4">
                        ...
                        <CardDescription
                            class="text-base text-muted-foreground"
                        >
                            Selecciona las categorías específicas a las que
                ...
                >
                    <CardHeader class="pb-4">
                        ...
                        <CardDescription
                            class="text-base text-muted-foreground"
                        >
                            Agrega autores, editores, traductores y otros
