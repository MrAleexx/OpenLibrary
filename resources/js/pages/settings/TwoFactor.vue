            ...
            <div class="space-y-6">
                ...
                <div v-if="!twoFactorEnabled" class="flex flex-col items-start justify-start space-y-4">
                    ...
                    <p class="text-muted-foreground">
                        Cuando habilitas la autenticación de dos factores, se te pedirá un PIN seguro durante el inicio
                ...
                <div v-else class="flex flex-col items-start justify-start space-y-4">
                    ...
                    <p class="text-muted-foreground">
                        Con la autenticación de dos factores habilitada, se te pedirá un PIN seguro y aleatorio durante
                        el inicio de sesión, que puedes obtener de la aplicación compatible con TOTP en tu teléfono.
                    </p>
